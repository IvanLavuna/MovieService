...
[
    [
        User(id=1, username="LaVuna",    firstname="Ivan",   lastname="Manchur",   email="LaVuna@gmail.com",    password_hash=User.hash_password("lavuna2002"),    phone_number="90123123",   photo="photo.jpeg"),
        User(id=2, username="Pikachu",   firstname="Borys",  lastname="Laplas",    email="Lapko@gmail.com",     password_hash=User.hash_password("laplap2002"),    phone_number="901231233",  photo="photo.jpeg"),
        User(id=3, username="Hulk",      firstname="Ostap",  lastname="Manchur",   email="trololol@gmail.com",  password_hash=User.hash_password("ostap19991999"), phone_number="517294381",  photo="photo.jpeg"),
        User(id=4, username="Padon",     firstname="Julian", lastname="*********", email="Padon@gmail.com",     password_hash=User.hash_password("qwerty123"),     phone_number="872368923",  photo="photo.jpeg"),
        User(id=5, username="AdrianZP",  firstname="Adrian", lastname="Bilder",    email="SubAndDub@gmail.com", password_hash=User.hash_password("all123"),        phone_number="90121233123",photo="photo.jpeg")
    ],
    [
